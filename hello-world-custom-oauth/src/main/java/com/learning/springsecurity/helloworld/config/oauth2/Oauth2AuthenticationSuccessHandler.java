...
import com.learning.springsecurity.helloworld.repository.MyAppUser;
import com.learning.springsecurity.helloworld.repository.UserRepository;
...
public class Oauth2AuthenticationSuccessHandler implements AuthenticationSuccessHandler {
	...
	//make it true for google oauth case to save user in db
	private boolean isGoogleOauth = false;
	...
	public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response,
		...
		if (isGoogleOauth && userRepository.findByUsername(authentication.getName()) == null) {
